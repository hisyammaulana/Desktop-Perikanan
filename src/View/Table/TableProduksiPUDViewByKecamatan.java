 ...
 * @author tantowi
 */
public class TableProduksiPUDViewByKecamatan extends javax.swing.JFrame {
...
//    }
    ...
    public TableProduksiPUDViewByKecamatan(String table) {
        initComponents();
        System.out.println(table);
        tblmodel = new DefaultTableModel(null,header);
        tbl_pud.setModel(tblmodel);
...
//            statement.setString(1, (String)cb_bulan.getSelectedItem());
    ...
    public TableProduksiPUDViewByKecamatan(String kolam, String kecamatan) {
    ...
    private void initComponents() {
        ...
        tbl_pud = new javax.swing.JTable();
        ...
        tbl_pud.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbl_pud.setFocusable(false);
        tbl_pud.setIntercellSpacing(new java.awt.Dimension(0, 0));
        tbl_pud.setRowHeight(25);
        tbl_pud.setSelectionBackground(new java.awt.Color(132, 205, 238));
        tbl_pud.setShowVerticalLines(false);
        tbl_pud.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(tbl_pud);
...
//        new IsiDataKolam().show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableProduksiPUDViewByKecamatan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//                new TableAllKecamatanViewByBulanKolam().setVisible(true);
    ...
    public javax.swing.JTable tbl_pud;
